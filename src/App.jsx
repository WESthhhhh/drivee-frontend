...
import { PrimaryInput, SecondaryInput, DisableInput, TextArea, FileInput } from "./components/formInputs";
    ...
    <>
      ...
      <div className="container mx-auto p-8">
        ...
        <from className="w-[500px]">
          ...
          <SecondaryInput label="Secondary Input" placeholder="Enter your email" />
          <DisableInput label="Disabled Input" placeholder="This input is disabled" />
