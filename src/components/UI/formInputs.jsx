        ...
        <div className="mb-4 w-[500px]">
            ...
            <div className="relative">
                <input
                    ...
                    className={`w-full p-2 border    ${error ? 'border-error' : succes ? 'border-success' : 'border-b50'} rounded-md focus:outline-none focus:ring-thin focus:ring-b75 focus:border-primary`} />
                {icon && (
        ...
        <div className="mb-4 w-[500px]">
            ...
            <div className="relative">
                <input
                    type={type}
                    placeholder={placeholder}
                    className="w-full p-2 border border-b50 rounded-md focus:outline-none focus:ring-thin focus:ring-b75 focus:border-primary"
                />
                {icon && (
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        <img src={`./assets/${icon}.png`} alt={icon} className="w-4 h-4" />
...
export const FileInput = ({ label }) => {
    return (
        <div className="mb-4 w-[500px]">
            <label className="block text-sm font-medium mb-[12px] text-primary">{label}</label>
            <div className="relative flex items-center border border-b50 rounded-md px-3 py-2 focus-within:ring-thin focus-within:ring-b75 focus-within:border-primary ">
...
export const TextArea = ({ label, placeholder }) => {
    return (
        <div className="mb-4 w-[500px]">
            ...
            <textarea
                placeholder={placeholder}
                className="w-full p-2 border border-b50 rounded-md h-24 focus:outline-none focus:ring-thin focus:ring-b75 focus:border-primary"
            />
        </div>
    );
};
