      ...
      <div className="bg-light rounded-large-md max-w-lg w-full max-h-[90vh] flex flex-col relative overflow-hidden">
        <div className="sticky top-0 bg-light z-10 pt-5 px-5 pb-4 border-b border-stroke">
          <div className="relative flex justify-center items-center">
            <h1 className="text-b200 font-bold text-xl text-center mt-4">School Verification</h1>
            <button 
              onClick={closeModal}
        ...
        <div className="p-5 flex-1 overflow-y-auto">
          <div className="space-y-5">
            <div className="mb-4">
              ...
              <div className="p-3 bg-b50 rounded-small-md border border-stroke">
                {schoolName}
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-between p-3 bg-b50 rounded-small-md border border-stroke">
