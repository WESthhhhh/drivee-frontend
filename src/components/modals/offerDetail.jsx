  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-[9999] p-4">
      <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <button 
          onClick={closeModal}
          className="absolute right-4 top-4 w-8 h-8 flex justify-center items-center bg-b50 rounded-lg text-blue-900 text-xl z-10"
        >
          <IoMdClose />
        </button>
        ...
        <div className="p-6">
          {/* Header */}
          <h1 className="text-blue-900 font-semibold text-2xl text-center pt-8">Offer Details</h1>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 my-8">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h2 className="text-blue-900 text-lg font-medium">{offer.person}</h2>
                <span className="inline-block px-3 py-1 bg-blue-50 text-blue-900 text-sm font-semibold rounded-md">
                  {offer.title}
                </span>
              </div>
            </div>
            <button className="px-5 py-2 bg-blue-50 text-blue-900 font-semibold rounded-lg hover:bg-blue-100 transition">
              View Profile
            </button>
          </div>
          ...
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-blue-900 font-semibold text-xl">{offer.name}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-6 border-t border-b border-blue-50">
              <div className="text-center p-4">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <FaRegClock className="text-blue-900 text-xl" />
              ...
              <div className="text-center p-4 border-t md:border-t-0 md:border-l border-blue-50">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <FaDollarSign className="text-blue-900 text-xl" />
              ...
              <div className="text-center p-4 border-t md:border-t-0 md:border-l border-blue-50">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <FaRegClock className="text-blue-900 text-xl" />
                  <span className="text-blue-900 font-semibold">Expiration</span>
                </div>
            ...
            {/* Location */}
            <div className="text-center">
              <h3 className="flex items-center justify-center gap-2 text-blue-900 font-semibold">
