  ...
  return (
    <div className="min-h-screen pt-[15rem] relative z-10 overflow-x-hidden text-tet">
      ...
      <div className="pointer-events-none">
        ...
        <img src={rect} className="absolute top-[55%] w-full max-w-full left-[-10px] z-0" alt="" />
      </div>

      {/* Content */}
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-2xl md:text-3xl text-center font-medium mb-20">
          Want to <span className="text-primary font-bold">Showcase Your Offers?</span> Here's How!
        </h2>

        {/* Card rows - matching Howitwork1's structure */}
        <div className="max-w-5xl mx-auto my-[4rem] flex flex-col gap-12">
          {/* First row */}
